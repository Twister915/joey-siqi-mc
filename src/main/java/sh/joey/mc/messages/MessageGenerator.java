...
public final class MessageGenerator {
    ...
    private static String getDayProceduralMessage() {
        ...
        return switch (template) {
            ...
            case 2 -> pickWithArticleCap(ADJECTIVES) + " " + pick(DISCOVERIES) + " awaits you today.";
            case 3 -> "The spirits whisper of " + pick(WHISPERS) + ".";
            case 4 -> "Legends speak of " + pickWithArticle(ADJECTIVES) + " " + pick(TREASURES) + " nearby.";
            ...
            case 9 -> "Somewhere, " + pickWithArticle(MOBS) + " is thinking about you.";
            ...
            case 12 -> pickWithArticleCap(MOBS) + " and " + pickWithArticle(MOBS) + " walk into a bar. The bar is your base. Run.";
            case 13 -> "If you listen closely, you can hear the " + pick(SOUNDS) + ".";
            case 14 -> "The " + pick(ORES) + " is out there. You can feel it.";
            case 15 -> pickWithArticleCap(MOBS) + " wonders if you'll " + pick(ACTIVITIES) + " today.";
            ...
            case 21 -> pickWithArticleCap(MOBS) + " dreams of finding " + pick(TREASURES) + ". Don't let it.";
            ...
            case 24 -> "News from the " + pick(BIOMES) + ": " + pickWithArticle(ADJECTIVES) + " " + pick(MOBS) + " was spotted.";
            ...
            case 28 -> pickWithArticleCap(ADJECTIVES) + " feeling hangs in the air. Time to " + pick(ACTIVITIES) + ".";
